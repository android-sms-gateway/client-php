...
final class MessageTest extends TestCase {
    ...
    public function testLegacyTextMessageStillSerializesMessageKey(): void {
        ...
        $this->assertSame(
            '{"id":null,"simNumber":null,"withDeliveryReport":true,"isEncrypted":false,"phoneNumbers":["+1234567890"],"message":"Hello","priority":0}',
            $json
        );
    }
    ...
    public function testMessageSerializesMmsMessageWithoutMessageKey(): void {
        ...
        $this->assertSame(
            '{"id":null,"simNumber":null,"withDeliveryReport":true,"isEncrypted":false,"phoneNumbers":["+1234567890"],"mmsMessage":' . self::MMS_FIXTURE . ',"priority":0}',
            $json
        );
    }

    public function testMessageRejectsUnsupportedContent(): void {
        $this->expectException(\InvalidArgumentException::class);

        new Message([], ['+1234567890']);
    }

    public function testMmsMessageNormalizesSparseAttachmentKeysToList(): void {
        $mms = new MmsMessage('Hello', 'World', [
            5 => new MmsAttachment('image/png', 'BASE64DATA', 'picture.png'),
        ]);
