...
class Message implements SerializableInterface {
    ...
    /**
     * @param mixed $message string or MmsMessage
    ...
    public function __construct(
        ...
        if (!is_string($message) && !($message instanceof MmsMessage)) {
            throw new \InvalidArgumentException('message must be a string or MmsMessage');
        }
